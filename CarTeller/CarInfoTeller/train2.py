    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        if i % opt_train.print_freq == 0:
            print('Train: Epoch[{}] [{}/{}] Loss:{:.6f}, Acc:{:.6f}'
                  .format(epoch, i, all_num, train_loss / ((i+1) * opt_train.batch_size), train_acc / ((i+1) * opt_train.batch_size)))
    print('***Train: Epoch[{}] Loss:{:.6f}, Acc:{:.6f}'
        ...
        for i, (images, target) in enumerate(val_loader):
            ...
            if i % opt_train.print_freq == 0:
                print('Val: [{}/{}] Loss:{:.6f}, Acc:{:.6f}'
                      .format(i, all_num, val_loss / ((i+1) * opt_train.batch_size), val_acc / ((i+1) * opt_train.batch_size)))
